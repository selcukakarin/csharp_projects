<%@ Page Title="" Language="C#" MasterPageFile="~/SiteKullanici.Master" AutoEventWireup="true" CodeBehind="ForumKonuAc.aspx.cs" Inherits="koleksiyoner.com.ForumKonuAc" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentKullanici" runat="server">
    ...
    <div class="center_content">
        <div class="center_title_bar">Konu aç</div>
        <div class="prod_box_big">
            <div class="top_prod_box_big"></div>
            <div class="center_prod_box_big">
                <div class="contact_form">
                    <div class="form_row">
                        <label class="contact" style="width:114px;"><strong>ForumKonuBaslik:</strong></label>
                        <asp:TextBox ID="txtKonuAdi" style="width:200px;" CssClass="contact_input" runat="server"></asp:TextBox>
                    </div>
                    <div class="form_row">
                        <label class="contact" style="width:114px;"><strong>ForumKonuIcerik:</strong></label>
                        <asp:DropDownList ID="DropDownListKategori" runat="server"></asp:DropDownList>

                    </div>
                    <div class="form_row">
                        <label class="contact" style="width:114px;"><strong>ForumKonuKategori:</strong></label>
                        <asp:TextBox ID="txtKonuIcerik" CssClass="contact_input" runat="server" TextMode="MultiLine" Height="97px" Width="210px"></asp:TextBox>
                    </div>

                    <div class="form_row">
                        <asp:Button ID="Button1" runat="server" Text="Konu Aç" Style="float: right; height: 26px;" OnClick="Button1_Click" />
                    </div>
                </div>
            </div>
