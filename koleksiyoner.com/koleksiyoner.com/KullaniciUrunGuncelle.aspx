<%@ Page Title="" Language="C#" MasterPageFile="~/SiteKullanici.Master" AutoEventWireup="true" CodeBehind="KullaniciUrunGuncelle.aspx.cs" Inherits="koleksiyoner.com.KullaniciUrunGuncelle" %>
            ...
            <div class="center_prod_box_big">
                <div class="contact_form">
                    ...
                    <div class="form_row">
                        ...
                        <asp:TextBox ID="txtFiyat" CssClass="contact_input" runat="server"></asp:TextBox>
                    </div>
                    <div class="form_row">
                        <label class="contact"><strong>&#304;lan Süresi:</strong></label>

                        <asp:TextBox ID="txtIlanSuresi" CssClass="contact_input" runat="server"></asp:TextBox>
                    </div>
                    <div class="form_row">
                    ...
                    <div class="form_row">
                        <asp:Button ID="Button1" runat="server" Text="Ürün Güncelle" Style="float: right; height: 26px;" OnClick="Button1_Click" />
                    </div>
                </div>
            </div>
